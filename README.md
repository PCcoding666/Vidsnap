...
See [the migration guide](docs/migration-to-harness.md), [implementation state](docs/implementation/2026-08-11-video-harness-loop-state.md), and [benchmark status](docs/benchmark-status.md).
